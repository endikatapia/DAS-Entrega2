...
public class ConexionBDComprobarToken extends Worker {


    public ConexionBDComprobarToken(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public Result doWork() {
        //En el servidor se encuentrá el PHP --> comprobarToken.php
        //Este PHP comprobará si el token ya existe en la BD remota.
        //La BD remota tokens se compone de estos elementos:
        //token: (PK) varchar(255)
        String direccion = "http://ec2-54-167-31-169.compute-1.amazonaws.com/etapia008/WEB/comprobarToken.php";
